...
<section className="relative w-full rounded-2xl overflow-hidden border border-gray-100 bg-white shadow-sm hover:shadow-md transition-shadow duration-200">
  ...
  <div className="h-44 md:h-52 w-full bg-gradient-to-r from-indigo-100 via-purple-100 to-emerald-100 relative">
    ...
    {/* Logo moved INSIDE the banner div, absolute at bottom-left */}
    <div className="absolute bottom-0 left-6 translate-y-1/2 h-20 w-20 md:h-24 md:w-24 rounded-2xl bg-white flex items-center justify-center overflow-hidden flex-shrink-0 border border-gray-100 shadow-sm z-10">
      {vendor.logo ? (
        <img
          src={vendor.logo}
          alt={vendor.name}
  ...
  <div className="px-4 md:px-6 mt-0 relative">
    <div className="flex flex-col md:flex-row md:items-center gap-4 bg-white/90 backdrop-blur-md rounded-2xl p-4 md:p-5 w-full md:w-auto border border-white/50 shadow-sm pt-14 md:pt-16 md:pl-32">
      ...
      <div className="flex-1 space-y-1 text-center md:text-left min-w-0">
        <div className="flex flex-col md:flex-row md:items-center md:gap-2 justify-center md:justify-start">
          ...
          {vendor?.user?.isActive && (
            <span className="mb-2 inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-700 text-xs font-semibold">
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-3 justify-center md:justify-start text-sm text-gray-600 mt-2">
